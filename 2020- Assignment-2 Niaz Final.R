...
summary.lm(riaz1)                    # adj. R^2 = 0.14
summary (riaz1)                      # summary of one way ANOVA
...
leveneTest(Parameters.data$Growth, Parameters.data$CPM)  # Levevtest for 
#The Shapiro Wilk's W test using linear regression model
shapiro.test(residuals(fit15))
#The Shapiro Wilk's W test using ANOVA
shapiro.test(residuals(riaz1))

# Residuals based Normality Test
...
#Graphically using on way ANOVA model. # Residuals are normally distributed 
...
# Normality test of residual plots 
